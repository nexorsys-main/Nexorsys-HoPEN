...
namespace Pinede.NFC.APP.Modeles
{
    ...
    {
        public string CheminEmed { get; set; } = "https://emed.clinique.local";
        public string CheminHestia { get; set; } = "https://hestia.clinique.local";
        public string CheminSigems { get; set; } = "C:\\Program Files\\SIGEMS\\SIGEMS.exe";
        public string CheminBlueKango { get; set; } = "https://bluekango.clinique.local";
    }
    ...
    public class SecuritySettings
    {
        ...
        public bool SsoActif { get; set; } = false;
    }
